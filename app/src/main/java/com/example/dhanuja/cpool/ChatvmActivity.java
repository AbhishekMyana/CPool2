...
public class ChatvmActivity extends AppCompatActivity {
...
//Active Users display - START
        FirebaseAuth firebaseAuthvm = FirebaseAuth.getInstance();
        FirebaseDatabase firebaseDatabasevm = FirebaseDatabase.getInstance();
        final DatabaseReference databaseReferencevm = firebaseDatabasevm.getReference("ActivevmUsers");

        databaseReferencevm.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ChatvmActivity.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
//Active Users display - END
        ...
        dref = firebaseDatabase.getReference("ChatvmActivity");
        list = new ArrayList<>();
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("ChatvmActivity").push().setValue(new ChatMessage(input.getText().toString(),
    ...
    public void onStart(){
        ...
        databaseReferencevm.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ActiveUsers activeUsers = dataSnapshot.getValue(ActiveUsers.class);
                CurrentNumber = activeUsers.getNumberactive();
                ActiveUsers newdata = new ActiveUsers(CurrentNumber + 1);
                databaseReferencevm.setValue(newdata);
            }
        ...
        super.onStart();
        Toast.makeText(ChatvmActivity.this,"You have entered the Chatroom", Toast.LENGTH_SHORT).show();
    ...
    public void onStop(){
        ...
        Toast.makeText(ChatvmActivity.this,"You have left the Chatroom", Toast.LENGTH_SHORT).show();
        super.onStop();
    }
